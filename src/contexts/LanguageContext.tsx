...
const translations = {
  vi: {
    ...
    'applications.manager.title': 'Đơn ứng tuyển cho',
    'applications.stats.total': 'Tổng',
    'applications.stats.pending': 'Chờ xử lý',
    'applications.stats.reviewed': 'Đã xem xét',
    'applications.stats.shortlisted': 'Lọc sơ bộ',
    'applications.stats.accepted': 'Chấp nhận',
    'applications.stats.rejected': 'Từ chối',
    'applications.filters.label': 'Lọc theo trạng thái',
    'applications.filters.all': 'Tất cả đơn ứng tuyển',
    'applications.filters.showing': 'Hiển thị',
    'applications.filters.of': 'trên',
    'applications.filters.applications': 'đơn ứng tuyển',
    'applications.loading': 'Đang tải đơn ứng tuyển...',
    'applications.empty.noApplications': 'Chưa có đơn ứng tuyển nào',
    'applications.empty.noStatusApplications': 'Không có đơn ứng tuyển với trạng thái này',
    'applications.empty.noApplicationsDescription': 'Đơn ứng tuyển sẽ xuất hiện ở đây khi người tìm việc bắt đầu ứng tuyển.',
    'applications.empty.noStatusApplicationsDescription': 'Hãy thử thay đổi bộ lọc để xem đơn ứng tuyển với trạng thái khác.',
    'applications.pagination.showing': 'Hiển thị',
    'applications.pagination.to': 'đến',
    'applications.pagination.of': 'trên',
    'applications.pagination.results': 'kết quả',
    'applications.pagination.previous': 'Trước',
    'applications.pagination.next': 'Tiếp',
    'applications.pagination.page': 'Trang',
    'applications.status.pending': 'Chờ xử lý',
    'applications.status.reviewed': 'Đã xem xét',
    'applications.status.shortlisted': 'Lọc sơ bộ',
    'applications.status.interview_scheduled': 'Đã lên lịch phỏng vấn',
    'applications.status.interview_completed': 'Hoàn thành phỏng vấn',
    'applications.status.offered': 'Được đề xuất',
    'applications.status.accepted': 'Chấp nhận',
    'applications.status.rejected': 'Từ chối',
    'applications.status.withdrawn': 'Đã rút',
    'applications.form.title': 'Ứng tuyển vị trí',
    'applications.form.coverLetter': 'Thư xin việc',
    'applications.form.resume': 'Hồ sơ',
    'applications.form.submit': 'Gửi đơn ứng tuyển',
    'applications.form.cancel': 'Hủy',
    'applications.actions.withdraw': 'Rút đơn',
    'applications.actions.confirmWithdraw': 'Bạn có chắc chắn muốn rút đơn ứng tuyển này? Hành động này không thể hoàn tác.',
    'applications.applySuccess': 'Đã gửi đơn ứng tuyển thành công!',
    'applications.applyError': 'Gửi đơn ứng tuyển thất bại',
    'applications.invalidFileType': 'Vui lòng chọn loại file hợp lệ (PDF, DOC, DOCX)',
    
    // My Applications Page
    'myApplications.title': 'Đơn Ứng Tuyển Của Tôi',
    'myApplications.subtitle': 'Theo dõi đơn ứng tuyển và trạng thái của bạn',
    'myApplications.stats.total': 'Tổng',
    'myApplications.stats.pending': 'Chờ xử lý',
    'myApplications.stats.approved': 'Đã duyệt',
    'myApplications.stats.rejected': 'Từ chối',
    'myApplications.filters.all': 'Tất cả đơn ứng tuyển',
    'myApplications.filters.pending': 'Chờ xử lý',
    'myApplications.filters.reviewed': 'Đã xem xét',
    'myApplications.filters.shortlisted': 'Lọc sơ bộ',
    'myApplications.filters.interviews': 'Phỏng vấn',
    'myApplications.filters.offers': 'Lời mời',
    'myApplications.filters.rejected': 'Từ chối',
    'myApplications.loading': 'Đang tải đơn ứng tuyển của bạn...',
    'myApplications.empty.noApplications': 'Chưa có đơn ứng tuyển nào',
    'myApplications.empty.noFilteredApplications': 'Không có đơn ứng tuyển với trạng thái này',
    'myApplications.empty.noApplicationsDescription': 'Bắt đầu ứng tuyển để xem đơn ứng tuyển của bạn tại đây',
    'myApplications.empty.noFilteredApplicationsDescription': 'Bạn không có đơn ứng tuyển nào với trạng thái này',
    'myApplications.empty.browseJobs': '🔍 Duyệt Việc Làm',
  ...
  en: {
    ...
    // Applications Management
    'applications.manager.title': 'Applications for',
    'applications.stats.total': 'Total',
    'applications.stats.pending': 'Pending',
    'applications.stats.reviewed': 'Reviewed',
    'applications.stats.shortlisted': 'Shortlisted',
    'applications.stats.accepted': 'Accepted',
    'applications.stats.rejected': 'Rejected',
    'applications.filters.label': 'Filter by status',
    'applications.filters.all': 'All Applications',
    'applications.filters.showing': 'Showing',
    'applications.filters.of': 'of',
    'applications.filters.applications': 'applications',
    'applications.loading': 'Loading applications...',
    'applications.empty.noApplications': 'No applications yet',
    'applications.empty.noStatusApplications': 'No applications with this status',
    'applications.empty.noApplicationsDescription': 'Applications will appear here once job seekers start applying.',
    'applications.empty.noStatusApplicationsDescription': 'Try changing the filter to see applications with different statuses.',
    'applications.pagination.showing': 'Showing',
    'applications.pagination.to': 'to',
    'applications.pagination.of': 'of',
    'applications.pagination.results': 'results',
    'applications.pagination.previous': 'Previous',
    'applications.pagination.next': 'Next',
    ...
    'applications.status.interview_scheduled': 'Interview Scheduled',
    ...
    'applications.form.title': 'Apply for Position',
    'applications.form.coverLetter': 'Cover Letter',
    'applications.form.resume': 'Resume',
    'applications.form.submit': 'Submit Application',
    'applications.form.cancel': 'Cancel',
    'applications.actions.withdraw': 'Withdraw',
    'applications.actions.confirmWithdraw': 'Are you sure you want to withdraw this application? This action cannot be undone.',
    'applications.applySuccess': 'Application submitted successfully!',
    'applications.applyError': 'Failed to submit application',
    'applications.invalidFileType': 'Please select a valid file type (PDF, DOC, DOCX)',
    
    // My Applications Page
    'myApplications.title': 'My Applications',
    'myApplications.subtitle': 'Track your job applications and their status',
    'myApplications.stats.total': 'Total',
    'myApplications.stats.pending': 'Pending',
    'myApplications.stats.approved': 'Approved',
    'myApplications.stats.rejected': 'Rejected',
    'myApplications.filters.all': 'All Applications',
    'myApplications.filters.pending': 'Pending',
    'myApplications.filters.reviewed': 'Reviewed',
    'myApplications.filters.shortlisted': 'Shortlisted',
    'myApplications.filters.interviews': 'Interviews',
    'myApplications.filters.offers': 'Offers',
    'myApplications.filters.rejected': 'Rejected',
    'myApplications.loading': 'Loading your applications...',
    'myApplications.empty.noApplications': 'No applications yet',
    'myApplications.empty.noFilteredApplications': 'No applications with this status',
    'myApplications.empty.noApplicationsDescription': 'Start applying for jobs to see your applications here',
    'myApplications.empty.noFilteredApplicationsDescription': 'You don\'t have any applications with this status',
    'myApplications.empty.browseJobs': '🔍 Browse Jobs',
  ...
  ja: {
    ...
    // Applications Management
    'applications.manager.title': 'への応募',
    'applications.stats.total': '合計',
    'applications.stats.pending': '保留中',
    'applications.stats.reviewed': '審査済み',
    'applications.stats.shortlisted': '書類選考通過',
    'applications.stats.accepted': '承認',
    'applications.stats.rejected': '不採用',
    'applications.filters.label': 'ステータスでフィルター',
    'applications.filters.all': 'すべての応募',
    'applications.filters.showing': '表示中',
    'applications.filters.of': '/',
    'applications.filters.applications': '応募',
    'applications.loading': '応募を読み込み中...',
    'applications.empty.noApplications': 'まだ応募がありません',
    'applications.empty.noStatusApplications': 'このステータスの応募はありません',
    'applications.empty.noApplicationsDescription': '求職者が応募を開始すると、ここに表示されます。',
    'applications.empty.noStatusApplicationsDescription': '他のステータスの応募を見るには、フィルターを変更してください。',
    'applications.pagination.showing': '表示中',
    'applications.pagination.to': '〜',
    'applications.pagination.of': '/',
    'applications.pagination.results': '結果',
    'applications.pagination.previous': '前へ',
    'applications.pagination.next': '次へ',
    'applications.pagination.page': 'ページ',
    'applications.status.pending': '保留中',
    'applications.status.reviewed': '審査済み',
    'applications.status.shortlisted': '書類選考通過',
    'applications.status.interview_scheduled': '面接予定',
    'applications.status.interview_completed': '面接完了',
    'applications.status.offered': '内定',
    'applications.status.accepted': '承認',
    'applications.status.rejected': '不採用',
    'applications.status.withdrawn': '辞退',
    'applications.form.title': 'ポジションへの応募',
    'applications.form.coverLetter': '志望動機書',
    'applications.form.resume': '履歴書',
    'applications.form.submit': '応募を送信',
    'applications.form.cancel': 'キャンセル',
    'applications.actions.withdraw': '辞退',
    'applications.actions.confirmWithdraw': 'この応募を辞退しますか？この操作は取り消せません。',
    'applications.applySuccess': '応募を正常に送信しました！',
    'applications.applyError': '応募の送信に失敗しました',
    'applications.invalidFileType': '有効なファイル形式を選択してください（PDF、DOC、DOCX）',
    
    // My Applications Page
    'myApplications.title': '私の応募',
    'myApplications.subtitle': '求人応募とその状況を追跡',
    'myApplications.stats.total': '合計',
    'myApplications.stats.pending': '保留中',
    'myApplications.stats.approved': '承認済み',
    'myApplications.stats.rejected': '不採用',
    'myApplications.filters.all': 'すべての応募',
    'myApplications.filters.pending': '保留中',
    'myApplications.filters.reviewed': '審査済み',
    'myApplications.filters.shortlisted': '書類選考通過',
    'myApplications.filters.interviews': '面接',
    'myApplications.filters.offers': '内定',
    'myApplications.filters.rejected': '不採用',
    'myApplications.loading': '応募を読み込み中...',
    'myApplications.empty.noApplications': 'まだ応募がありません',
    'myApplications.empty.noFilteredApplications': 'このステータスの応募はありません',
    'myApplications.empty.noApplicationsDescription': '求人に応募を始めて、ここで応募を確認してください',
    'myApplications.empty.noFilteredApplicationsDescription': 'このステータスの応募はありません',
    'myApplications.empty.browseJobs': '🔍 求人を探す',
